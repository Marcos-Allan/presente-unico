...
export function Mug(props: any) {
  ...
  console.log(localStorage.getItem('estampa-visu3d'))
  
  // const texture = useTexture("https://pngfre.com/wp-content/uploads/anime-poster.png");
  const test:any = localStorage.getItem('estampa-visu3d')
  const decodedUrl = decodeURIComponent(test);
  const texture = useTexture(decodedUrl, (err) => {
    if (err) console.error("Erro ao carregar textura", err);
  });
